	...
	<body>
		<div class="wrapper">
			<!-- <form method="post" action="http://localhost:8080/dev-leave-form/leave-form/add"> -->
				<input type="hidden" id="EditCode" value="<?php echo $this->uri->segment(2); ?>">
								...
								<table class="inpt-grp">
									...
									<tr>
										<td class="inpt tplr" colspan="4">
											<table id="checkTypes">
												<tr>
													<input type="hidden" id="contLeave" name="contLeave" value="<?php echo $edit['title']; ?>">
													<td class="space"></td>
								...
								<table>
									<tr>
										...
										<td class="inpt text-center" style="width: 2.44in">
											<input type="hidden" id="fromEdit" value="<?php echo date('m/d/Y H:i:s A',strtotime($edit['start'])); ?>">
										...
										<td class="inpt text-center" style="width: 2.61in">
											<input type="hidden" id="toEdit" value="<?php echo date('m/d/Y H:i:s A',strtotime($edit['end'])); ?>">
									...
									<tr>
										<td colspan="4" class="lv-container">
											...
											<div class="lv-checkbox">
												<table>
													<tr>
														<input type="hidden" id="regular" name="regular" value="<?php echo $edit['types']; ?>">
														<td class="space"></td>
														...
														<td style="width: 0.2in;"><input type="text" name="noDays" id="noDays" value="<?php echo $edit['days']; ?>" style=" text-align: center;" /></td>
											...
											<div class="rfl">
												...
												<div class="rfl-inpt"><input type="text" name="reason" id="reason" value="<?php echo $edit['reason']; ?>" /></div>
											</div>
										</td>
									</tr>
									<tr>
